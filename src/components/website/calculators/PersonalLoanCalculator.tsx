      ...
      <div className="mt-10 space-y-8">
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed mb-3">
            This personal loan calculator supports both the flat rate and reducing balance methods commonly used for personal loans in Malaysia. For flat rate loans, interest is calculated on the original principal throughout the tenure. For reducing balance loans, interest is calculated on the remaining outstanding balance after each repayment. Select the calculation method that matches your loan offer, then enter the loan amount, interest rate, and tenure to get your estimated monthly instalment and total cost.
          </p>
        </div>
        <div>
          <h2 className="text-2xl font-bold mb-3">How to Use This Calculator</h2>
          <p className="text-muted-foreground leading-relaxed">
            First, select whether your personal loan uses the flat rate or reducing balance method — check your loan agreement or ask your bank if unsure. Enter the loan amount you wish to borrow. Enter the annual interest rate offered by your bank. Enter the loan tenure in years (typically 1 to 7 years for Malaysian personal loans). Click Calculate to see the monthly instalment, total interest, and total repayment amount.
          </p>
        </div>
        <div>
          <h2 className="text-2xl font-bold mb-3">Common Mistakes When Estimating Personal Loans</h2>
          <ul className="list-disc list-inside space-y-2 text-muted-foreground leading-relaxed">
            <li>Confusing flat rate with reducing balance — a 6% flat rate personal loan is equivalent to roughly 10-11% effective rate.</li>
            <li>Not checking for early settlement penalties — most Malaysian personal loans charge a penalty of 1-3% if settled early.</li>
            <li>Ignoring processing fees and stamp duty — these one-time costs can add RM 100 to RM 500 to your initial outlay.</li>
            <li>Borrowing more than needed just because the bank approves a higher amount — this increases your monthly commitment and total interest.</li>
            <li>Not comparing offers from multiple banks — rates can vary by 2-4% between different financial institutions.</li>
          </ul>
        </div>
        <div>
          <h2 className="text-2xl font-bold mb-3">Important Limitations</h2>
          <p className="text-muted-foreground leading-relaxed">
            This calculator provides estimates only and does not reflect actual bank approval amounts, processing fees, stamp duty, or individual borrower risk assessments. Actual monthly instalments may differ due to rounding, insurance coverage requirements, and other charges. Interest rates and lending policies change frequently — always verify current rates directly with your preferred bank before making any borrowing decision.
          </p>
        </div>
      </div>
    </div>
