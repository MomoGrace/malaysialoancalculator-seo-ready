      ...
      <div className="mt-10 space-y-8">
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed mb-3">
            This legal fee calculator estimates common legal costs associated with property purchase and loan agreement in Malaysia. It provides approximate figures based on commonly referenced fee scales used in Malaysian property transactions. The calculator estimates two main components: legal fees for the Sale and Purchase Agreement (SPA), and stamp duty on the property transfer and loan agreement. Legal fees for property transactions in Malaysia are typically calculated on a sliding scale based on the property value, and stamp duty rates are set by the government under the Stamp Act 1949.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed">
            Enter the property purchase price in Ringgit Malaysia (RM). If you are also taking a bank loan, enter the loan amount. The calculator will estimate the legal fees based on the property price and the stamp duty based on both the property transfer and the loan agreement. Click Calculate to see the breakdown of estimated costs. Note that the actual fees charged by your lawyer may vary depending on the specific law firm, whether any stamp duty exemptions apply (e.g., for first-time homebuyers under the Budget initiatives), and whether the property is residential or commercial.
          </p>
        </div>

        <div>
          <h2 className="text-2xl font-bold mb-3">Common Mistakes When Estimating Legal Fees</h2>
          <ul className="list-disc list-inside space-y-2 text-muted-foreground leading-relaxed">
            <li>Forgetting that legal fees are separate from stamp duty — these are two different costs charged by different parties (lawyer vs government).</li>
            <li>Not checking for stamp duty exemptions — first-time homebuyers may qualify for full or partial stamp duty exemption on properties under certain price thresholds.</li>
            <li>Assuming the calculator covers all costs — there may be additional charges for disbursements, search fees, registration fees, and documentation costs.</li>
            <li>Using the wrong property value — legal fee scales apply to the property purchase price, not the loan amount.</li>
            <li>Not getting a written quote from your lawyer — actual legal fees should be confirmed in writing before engaging the firm.</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed">
            This calculator provides rough estimates only and does not reflect actual legal fees charged by any specific law firm, current stamp duty rates (which may change with government Budget announcements), or any exemptions you may qualify for. The fee scales used are based on commonly referenced ranges and may not match the exact scale applied by your lawyer. This tool does not account for Memorandum of Transfer (MOT) fees, disbursements, land search fees, or other transaction costs. Always obtain a formal written quotation from a licensed lawyer before proceeding with any property transaction in Malaysia.
          </p>
        </div>
      </div>
    </div>
